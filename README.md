...
<img width="1410" height="2000" alt="image" src="https://github.com/user-attachments/assets/98c472d5-8af7-479d-b1a0-bb3f6d6ca148" />
...
4. Place the thermal printer on top of the platform so that the wires from the bottom fit through the cutout on the platform.
5. Wires should snap into place on the sides.
6. Connect the button to the wire and loop the wire through the hole in the cap. 
